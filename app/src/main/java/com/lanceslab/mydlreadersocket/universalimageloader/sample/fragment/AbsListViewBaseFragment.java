...
import com.lanceslab.mydlreadersocket.universalimageloader.sample.core.listener.PauseOnScrollListener;
...
//		intent.putExtra(Constants.Extra.IMAGE_POSITION, position);
	...
	protected void startImageTransferActivity(int position) {
		Intent intent = new Intent(getActivity(), SimpleImageActivity.class);
		//ImagePagerFragment.INDEX = 2 ?????????????
